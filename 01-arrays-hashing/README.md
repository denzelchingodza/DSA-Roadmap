...
| Valid Anagram | `problems/valid_anagram.py` | Frequency counting | O(n log n) / O(n) | O(n) / O(1)* | Anagram-ness is about letter *counts*, not order — sorting pays for order you don't need. |
